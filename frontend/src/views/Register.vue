  ...
  <div class="page-shell">
    <div class="page-grid">
      <section class="hero-panel">
        ...
        <h1>立即加入 TRAINX</h1>
        <p>
          用最直观的方式开始你的算法竞赛训练，支持 ICPC、CCPC、蓝桥杯、百度之星等多赛道备战。
        </p>
      ...
      <div class="auth-card">
        <div class="card-header">
          ...
          <h2 class="card-title">TRAINX REGISTER</h2>
          <p class="card-subtitle">创建账号，开启你的竞赛训练之旅</p>
        </div>
        ...
        <button @click="register" class="icpc-btn" :disabled="loading">
        ...
        <div class="icpc-link">
          <span @click="goLogin">BACK TO LOGIN</span>
        </div>
      </div>
    </div>
  </div>
...
const register = async () => {
  ...
  try {
    ...
    message.value = res.data.msg || '注册成功，请登录'
    messageType.value = 'success'
    setTimeout(() => router.push('/login'), 700)
  } catch (err) {
    message.value = err.response?.data?.detail || '注册失败，请重试'
